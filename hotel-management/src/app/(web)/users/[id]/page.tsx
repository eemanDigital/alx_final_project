/**
 * This component fetches user details, bookings, and provides functionalities like signing out, displaying user information,
 * displaying current bookings, amount spent, and allowing users to submit reviews and ratings.
 *
 * @param {Object} props - Props containing the user ID.
 * @param {Object} props.params - Object containing the user ID as a parameter.
 * @param {string} props.params.id - The ID of the user.
 * @returns {JSX.Element} - Returns a JSX element that displays user details, bookings, and options to view bookings, amount spent, and submit reviews.
 */
