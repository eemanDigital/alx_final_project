 ...
 *
 * This component displays a photo gallery for a hotel room.
 * It shows images of the room and provides navigation to view different photos.
 *
 * @param {photos: ImageType[]} photos - An array of ImageType objects representing room photos.
 */
...
const HotelPhotoGallery: FC<{ photos: ImageType[] }> = ({ photos }) => {
  // State variables for managing the current photo index and modal visibility
  const [currentPhotoIndex, setCurrentPhotoIndex] = useState(0);
  const [showModal, setShowModal] = useState(false);

  // Function to open the modal and display a specific photo
  ...
  // Functions to handle navigation between photos
  ...
  // Constants to manage visible and remaining photos
  ...
  return (
    // Component structure for the photo gallery using Next.js Image component
    <div className="container mx-auto">
      ...
      <div className="grid md:grid-cols-2 relative gap-5 px-3">
        ...
        <div className="h-[540px] relative rounded-2xl overflow-hidden">
          {/* Display of the main photo for different screen sizes */}
        ...
        {/* Display of additional photos in a grid */}
        ...
        {/* Modal to display enlarged photo */}
        {showModal && (
